...
const FaqBlock = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Чтобы обменивать криптовалюту на uah, usd и другие валюты, нужно пройти верификацию. Для этого зайдите на сайт, перейдите в личный кабинет, выберите тип документов, который будете использовать для верификации и загрузите селфи.",
        },
        {
