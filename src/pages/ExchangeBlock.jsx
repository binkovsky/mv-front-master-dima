...
const ExchangeBlock = () => {
    ...
    return (
        <div className="w-full bg-[#15344D] flex flex-col justify-center items-center p-14 font-urbanist">
            <div className="flex w-full max-w-xl bg-[#23445F] rounded-t-lg  ">
                <button
            ...
            <div className="w-full max-w-xl bg-main p-6 rounded-2xl rounded-t-none shadow-md">
                ...
                <div className={'w-full h-5 flex items-center justify-center relative'}>
                    <div
                        className={"absolute w-12 h-12 flex justify-center items-center bg-white rounded-full border-2"}>
